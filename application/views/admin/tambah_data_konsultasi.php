        ...
        <!-- Content Header (Page header) -->
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="<?php echo base_url(); ?>admin/data_utama">Data Konsultasi</a></li>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group" >
                    <label for="exampleInputEmail1">Isi Konsultasi</label>
                      <textarea onkeyup="resizeTextarea('isi_konsultasi')" id="isi_konsultasi" class="form-control" name="isi_konsultasi" placeholder="Isi Konsultasi" required ></textarea>
                  </div>
                  ...
                  <div class="form-group" >
                   ...
                   <div class="form-group" >
                       <input readonly type="hidden" value="<?php echo date("Y/m/d h:i:sa") ; ?>" class="form-control" name="tgl_konsultasi" placeholder="Tgl Konsultasi"/>
                    </div>
